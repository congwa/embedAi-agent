...
FACT_EXTRACTION_PROMPT = """你是一个精准的事实抽取助手。请从以下对话中提取用户的关键事实信息。
...
MEMORY_ACTION_PROMPT = """你是一个记忆管理助手。请判断如何处理新事实与现有记忆的关系。
...
GRAPH_EXTRACTION_PROMPT = """你是一个知识图谱抽取助手。请从以下对话中提取实体和关系。
